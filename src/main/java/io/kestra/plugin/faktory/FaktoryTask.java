    ...
    examples = {
        @io.kestra.core.models.annotations.Example(
            ...
            code = """
                ...
                tasks:
                  - id: reverse
                    type: io.kestra.plugin.faktory.FaktoryTask
                    format: "Text to be reverted"
                """
        )
    }
)
public class FaktoryTask extends Task implements RunnableTask<FaktoryTask.Output> {
    @Schema(
    ...
    @Override
    public FaktoryTask.Output run(RunContext runContext) throws Exception {
